...
You should consult the Mozilla Developer Network (MDN) for reference on any method with which you 
are not familiar.
*/
...
const indexRight = secretMessage.indexOf("easily");
secretMessage[indexRight] = "right";
